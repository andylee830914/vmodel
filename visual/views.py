...
def model(request):
    ...
    parameter = {
        ...
        'theta_m'       : {'name': r'\(\theta _m\)' ,'show': 1 , 'default': 0.2},
        'f_e'           : {'name': r'\(f_e\)'       ,'show': 1 , 'default': 0.276},
        'f_l'           : {'name': r'\(f_l\)'       ,'show': 1 , 'default': 0.11},
        'f_p'           : {'name': r'\(f_p\)'       ,'show': 1 , 'default': 0.253},
        'mu_e'          : {'name': r'\(\mu_e\)'     ,'show': 1 , 'default': 0.05},
        'mu_l'          : {'name': r'\(\mu_l\)'     ,'show': 1 , 'default': 0.05},
        'mu_p'          : {'name': r'\(\mu_p\)'     ,'show': 1 , 'default': 0.0167},
        'mu_m'          : {'name': r'\(\mu_m\)'     ,'show': 1 , 'default': 0.047},
        'pi'            : {'name': r'\(\pi\)'       ,'show': 1 , 'default': 1},
        'r'             : {'name': r'r'             ,'show': 1 , 'default': 13.6},
        'sigma'         : {'name': r'\(\sigma\)'    ,'show': 1 , 'default': 0.5},
        ...
        'perWorkLength' : {'name': r'perWorkLength' ,'show': 0 , 'default': 1*1000},        
        'sprayTime'     : {'name': r'sprayTime'     ,'show': 0 , 'default': []},
        ...
        'waterTime'     : {'name': r'waterTime'      ,'show': 0 , 'default': []},  # [50,100,150,200]
